...
export MODEL_NAME=Qwen2.5-VL-3B-Instruct_clevrer_counterfactual_videothinker_r1
...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node="2" \
    ...
    --ref_model_path $PRIVATE_DATA_ROOT/Training/Qwen2.5-VL-3B-Instruct_clevrer_counterfactual_bias_model/checkpoint-500 \
    --dataset_name xxx \
    --jsonl_path data/CLEVRER/clevrer_counterfactual_train.json \
