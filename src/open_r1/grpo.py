...
def create_dataset_from_jsonl_simple(jsonl_path, question_type, train_samples=2000):
    ...
    # Maintain difficulty distribution when selecting samples
...
def main(script_args, training_args, model_args):    
    ...
    if not hasattr(model_args, 'ref_model_path'):
        model_args.ref_model_path = None
